...
df = pd.read_csv("/Users/manyasingh/Desktop/COMP479/diabetes_binary_5050split_health_indicators_BRFSS2015.csv")
...
logistic = KNeighborsClassifier(n_neighbors=best_params['C'])
...
income_f1_scores = df_eval.groupby('Income').apply(lambda x: f1_score(x['True_Label'], x['Predicted_Label'])).rename(
    'F1_Score')
